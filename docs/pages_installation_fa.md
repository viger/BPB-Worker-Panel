...
حالا به آدرس گیتهاب [BLOG-Worker-Panel](https://github.com/bia-pain-bache/BLOG-Worker-Panel) میرید و از اون بالا دکمه‌ی Fork رو میزنید.
<br><br>
<p align="center">
...
اینجا روی `BLOG-Worker-Panel` کلیک کنید تا فعال بشه و `Begin Setup` رو بزنید. مرحله‌ی بعد یه `Project Name` داره که میشه دامین پنل شما، اونو حتما عوض کنید که کلمه‌ی bpb توش نباشه و یه اسم دلخواه بذارید وگرنه ممکنه اکانتتون توسط کلادفلر شناسایی بشه.
